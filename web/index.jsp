                                        ...
                                        <div class="navArea">
                                            <div class="navbar-collapse collapse">
                                                <ul class="nav navbar-nav">
                                                    ...
                                                    <li class="menuItem"><a href="#informacion">InformaciÛn Convocatoria</a></li>
                                                    <li class="menuItem"><a href="#registrarse">Registrarse</a></li>
                                                    <li class="menuItem"><a href="#iniciosesion">Iniciar SesiÛn</a></li>                                                   
                ...
                <div class="container">
                    ...
                    <form>
                        ...
                        <div class="convocatoria">
                            <label for="CedulaInput">AÒo Convocatoria:  <%out.print(c.getD_anoConvocatoria());%> </label><br>
...
<section class="registrarse" id="registrarse">
    <div class="container w960">
        <div class="heading">
            ...
            <h2>Registrarse</h2>
            <img class="dividerline" src="img/sep.png" alt="">
            <h3>Digite su codigo para iniciar el proceso de Registro al Apoyo Alimentario de la Universidad Distrital Francisco JosÈ de Caldas<br>
            </h3>
        </div>
        <div class="row">
            <form class="form-login" action="login/registrarUsuario.jsp" method="post" >

                <input type="text" name='ruser' class="form-control" placeholder="CÛdigo Estudiante"  required>
                <br>
                <input type="password" name='rpasswd' class="form-control" placeholder="ContraseÒa"  required>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Olvido su ContraseÒa ?</h4>
                        </div>
                        <div class="modal-body">
                            <p>Digite su email para recuperar su contraseÒa.</p>
